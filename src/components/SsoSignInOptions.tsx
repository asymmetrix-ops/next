...
type SsoSignInOptionsProps = {
  dividerBackgroundClassName?: string;
};

export default function SsoSignInOptions({
  dividerBackgroundClassName = "bg-white",
}: SsoSignInOptionsProps) {
  return (
    <div className="space-y-3">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span
            className={`px-3 text-gray-500 ${dividerBackgroundClassName}`}
          >
            Or sign in with SSO
          </span>
        </div>
