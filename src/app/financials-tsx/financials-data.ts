...
export const FIN_RAW_ROWS: RawRow[] = [
  ['MSCI',                   'Index Providers',           'ETF',              'United States', 'Public',   '#1F35C4', 5800,  2650, 14,  1620, 61.1, 1510, 41200,  [11,12,12,13,13,14,14] ],
  ['S&P Global',             'Index Providers',           'Ratings',          'United States', 'Public',   '#182A9B', 40000, 13800, 8,  6900, 50.0, 6300, 138000, [7,8,8,9,9,10,8] ],
  ["Moody's",                'Credit & Risk',             'Ratings',          'United States', 'Public',   '#2A46EA', 14800, 6850, 10,  3120, 45.5, 2880, 76000,  [8,9,9,10,10,11,10] ],
  ['Morningstar',            'Investment Research & Data','Equity research',  'United States', 'Public',   '#3D5BF3', 11900, 2280, 11,  462,  20.3, 380,  13900,  [10,11,11,12,11,11,11] ],
  ['PitchBook Data',         'Private Markets',           'Private markets',  'United States', 'Public',   '#1F35C4', 3100,  420,  18,  118,  28.1, 95,   4900,   [14,16,18,20,19,18,18] ],
  ['Preqin',                 'Alt. Investments',          'Private markets',  'United Kingdom','PE-owned', '#2A46EA', 520,   215,  22,  69,   32.0, 58,   3100,   [16,18,21,22,22,22,22] ],
  ['With Intelligence',      'Capital Markets Data',      'Pricing',          'United Kingdom','PE-owned', '#3D5BF3', 720,   180,  15,  47,   26.1, 38,   1850,   [10,11,13,14,15,15,15] ],
  ['Sustainalytics',         'ESG & Sustainability',      'Climate',          'Netherlands',   'Public',   '#7A5BD0', 1900,  310,  14,  75,   24.2, 62,   3800,   [12,13,14,14,14,14,14] ],
  ['Mergermarket',           'M&A / Deal Data',           'M&A advisory',     'United Kingdom','PE-owned', '#1F35C4', 480,   160,  12,  45,   28.1, 38,   1650,   [9,10,11,12,12,12,12] ],
  ['Acuris',                 'Credit & Risk',             'Ratings',          'United States', 'PE-owned', '#93A6F7', 640,   210,  13,  63,   30.0, 53,   2380,   [10,11,12,12,13,13,13] ],
  ['Cerved',                 'Credit & Risk',             'Ratings',          'Italy',         'PE-owned', '#2A46EA', 2200,  520,  10,  161,  31.0, 130,  5200,   [8,9,9,10,10,10,10] ],
  ['Burgiss',                'Private Markets',           'Private markets',  'United States', 'Public',   '#3D5BF3', 380,   120,  18,  41,   34.0, 35,   1700,   [12,13,14,14,14,14,14] ],
  ['Statista',               'Market Intelligence',       'Workflow software','Germany',       'PE-owned', '#1F35C4', 1100,  95,   20,  25,   26.2, 19,   850,    [7,8,8,9,9,9,9] ],
  ['Coalition Greenwich',    'Capital Markets Data',      'Equity research',  'United States', 'PE-owned', '#182A9B', 250,   110,  11,  24,   22.0, 19,   1050,   [8,9,9,10,9,9,9] ],
  ['Dealogic',               'Capital Markets Data',      'M&A advisory',     'United Kingdom','PE-owned', '#2A46EA', 420,   195,   9,  68,   34.9, 60,   2150,   [9,10,10,11,11,11,11] ],
  ['Bureau van Dijk',        'Credit & Risk',             'Workflow software','Belgium',       'Public',   '#3D5BF3', 900,   340,   7,  119,  35.0, 102,  3650,   [8,9,9,10,10,10,10] ],
];
