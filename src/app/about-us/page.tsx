      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="px-4 py-20 bg-gray-50">
          <div className="mx-auto max-w-6xl">
            ...
            {/* Headings row */}
            <div className="grid gap-10 mb-8 md:grid-cols-2 lg:grid-cols-4">
              <h3 className="text-3xl font-bold text-gray-900">The Founder</h3>
              <h3 className="text-3xl font-bold text-gray-900">VP Research</h3>
              <h3 className="text-3xl font-bold text-gray-900">Research Analyst</h3>
              <h3 className="text-3xl font-bold text-gray-900">Research Intern</h3>
            </div>
            ...
            <div className="grid gap-10 mb-16 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                <div className="p-8 mx-0 max-w-md bg-white rounded-lg shadow-lg">
                  ...
                  <p className="mb-4 text-gray-600">Research Analyst</p>
                  <a
