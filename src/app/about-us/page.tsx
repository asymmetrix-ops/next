          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-10 mb-16 md:grid-cols-2">
              ...
              <div className="flex gap-6 items-start p-6 bg-white rounded-lg shadow-lg">
                <div className="flex-shrink-0">
                  <Image
                    src="/images/jared_headhsot.jpeg"
                    alt="Jared Bochner"
                    width={180}
                    height={180}
                    className="object-cover w-44 h-44 rounded-full"
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-3 text-sm text-gray-600">VP Research</p>
                  <div className="flex gap-2">
                    <a
              ...
              <div className="flex gap-6 items-start p-6 bg-white rounded-lg shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-3 text-sm text-gray-600">Research Analyst</p>
                  <div className="flex gap-2">
                    <a
                      href="https://www.linkedin.com/in/alex-g-283206268/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex justify-center items-center w-8 h-8 text-white bg-blue-600 rounded-full transition-colors hover:bg-blue-700"
                      aria-label="Alex Grishko's LinkedIn profile"
                    >
                      <svg
                        width="16"
                        height="16"
              ...
              <div className="flex gap-6 items-start p-6 bg-white rounded-lg shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    <a
                      href="https://www.linkedin.com/in/dawnn-dinsey/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex justify-center items-center w-8 h-8 text-white bg-blue-600 rounded-full transition-colors hover:bg-blue-700"
                      aria-label="Dawnn Dinsey's LinkedIn profile"
                    >
                      <svg
                        width="16"
                        height="16"
              ...
              {/* Sam Hicks */}
              <div className="flex gap-6 items-start p-6 bg-white rounded-lg shadow-lg">
                <div className="flex-shrink-0 overflow-hidden w-44 h-44 rounded-full">
                  <Image
                    src="/images/sam.jpeg"
                    alt="Sam Hicks"
                    width={180}
                    height={180}
                    className="object-cover object-[center_38%] w-44 h-44 scale-[1.75]"
                  />
                </div>
                <div className="flex-1">
                  <h4 className="mb-1 text-xl font-bold text-gray-900">
                  ...
                  <div className="flex gap-2">
                    <a
                      href="https://www.linkedin.com/in/samhicks/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex justify-center items-center w-8 h-8 text-white bg-blue-600 rounded-full transition-colors hover:bg-blue-700"
                      aria-label="Sam Hicks's LinkedIn profile"
                    >
                      <svg
                        width="16"
                        height="16"
              ...
              <div className="flex gap-6 items-start p-6 bg-white rounded-lg shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-3 text-sm text-gray-600">Developer</p>
                  <div className="flex gap-2">
                    <a
                      href="https://www.linkedin.com/in/ivan-tucha/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex justify-center items-center w-8 h-8 text-white bg-blue-600 rounded-full transition-colors hover:bg-blue-700"
                      aria-label="Ivan Tucha's LinkedIn profile"
                    >
                      <svg
                        width="16"
                        height="16"
