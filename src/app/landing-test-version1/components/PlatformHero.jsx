...
const TABS = [
  ...
  // PENDING: built ahead of legal/insurance clearance, not to be published
  // until confirmed. Headline, body copy and tab label are drafts awaiting
  // PA / Jordan sign-off — do not merge to master until both are given.
  {
    id: "news",
    label: "News",
    eyebrow: "News",
