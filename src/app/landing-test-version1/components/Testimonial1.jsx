      ...
      <div className="container w-full max-w-lg">
        <div className="flex flex-col items-center text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            &ldquo;Asymmetrix gave us visibility into deal flow we didn&apos;t
            know existed. We&apos;ve closed two investments we would have
            missed entirely.&rdquo;
          </blockquote>
