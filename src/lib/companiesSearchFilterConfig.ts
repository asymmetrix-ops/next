...
export const OTHER_OWNERSHIP_TYPE_IDS = OTHER_OWNERSHIP_TYPES.map(
  (item) => item.id
);
...
export function ownershipFilterParamToTab(
  ownershipFilter: string | null | undefined
): OwnershipTab | undefined {
  switch (ownershipFilter) {
    case "public":
      return "public";
    case "private_equity_owned":
      return "pe";
    case "venture_capital_backed":
      return "vc";
    case "private":
      return "private";
    default:
